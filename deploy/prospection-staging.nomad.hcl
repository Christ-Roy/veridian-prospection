...
DEPLOY_ENV=staging
X402_ENABLED=0
X402_PUBLIC_BASE_URL=https://search-dev.staging.veridian.site
TRIAL_DAYS=7
...
ODH_CLICKHOUSE_URL=http://100.92.215.42:18123
ODH_CLICKHOUSE_USER=odh
ODH_CLICKHOUSE_DATABASE=odh
ODH_CLICKHOUSE_SEARCH_TABLE=company_search_current
ODH_CLICKHOUSE_TIMEOUT_MS=5000
ODH_CLICKHOUSE_MAX_ROWS_TO_READ=2000000
ODH_CLICKHOUSE_MAX_BYTES_TO_READ=268435456
...
ODH_CLICKHOUSE_PASSWORD={{ .ODH_CLICKHOUSE_PASSWORD }}
HUB_WEBHOOK_TOKEN={{ .HUB_WEBHOOK_TOKEN }}
TELNYX_PUBLIC_KEY={{ .TELNYX_PUBLIC_KEY }}
{{ end }}
EOH
